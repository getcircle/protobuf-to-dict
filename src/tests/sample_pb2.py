...
_MESSAGEOFTYPES = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='optional_string', full_name='tests.MessageOfTypes.optional_string', index=20,
